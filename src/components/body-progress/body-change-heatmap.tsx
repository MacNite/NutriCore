...
export function BodyChangeHeatmap({
  ...
  /* Tapping a body region opens the panel, because that is where its detail
     line and its written value live. */
  ...
  return (
    <div className="body-change-block">
      ...
      <BodyFold
        label={t("change.microHead")}
        open={expanded}
        onToggle={() => {
          setFoldOpen(!expanded);
          if (expanded) onActive(null);
        }}
      >
