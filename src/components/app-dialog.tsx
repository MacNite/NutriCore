...
export function AppDialog({ id, title, closeLabel, trigger, triggerClassName = "btn btn-quiet", initialOpen = false, openEvent, onClose, secondaryTrigger, secondaryTriggerLabel, secondaryAutoFocusTarget, children }: {
