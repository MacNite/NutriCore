...
export function LogRecipeForm({ id, date, portionWeightG, initialQuantity = 1 }: { id: string; date: string; portionWeightG: number; initialQuantity?: number }) {
